...
test.describe("Article API | list and full CRUD", () => {
  test("should return paginated list of articles limited to 10", async ({
    api,
  }) => {
  ...
  test("should create article, get by slug, update, get again, delete and verify 404 after delete", async ({
    api,
  }) => {
